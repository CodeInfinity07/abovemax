                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="why-right">
                            ...
                            <p class="mb-15">AboveMax is the partner of choice for many of the world’s leading enterprises,
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="icon-box-s2 s2 border-s1 bg bg1 text-center">
                            ...
                            <div class="content-box">
                                <h5><a href="/web-development">Web Development</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="icon-box-s2 s2 border-s1 bg bg2 text-center">
                            ...
                            <div class="content-box">
                                <h5><a href="/mobile-development">Mobile Development</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="icon-box-s2 s2 border-s1 bg bg3 text-center">
                            ...
                            <div class="content-box">
                                <h5><a href="/mobile-development">UI/UX Design</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30 mb-md-0">
                        <div class="icon-box-s2 s2 border-s1 bg bg4 text-center">
                            ...
                            <div class="content-box">
                                <h5><a href="/mobile-development">QA & Testing</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30 mb-md-0">
                        <div class="icon-box-s2 s2 border-s1 bg bg5 text-center">
                            <div class="icon-main"><span class="flaticon-report-1"></span></div>
                            <div class="content-box">
                                <h5><a href="/it-services">IT Counsultancy</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="icon-box-s2 s2 border-s1 bg bg6 text-center">
                            <div class="icon-main"><span class="flaticon-best"></span></div>
                            <div class="content-box">
                                <h5><a href="/it-services">Dedicated Team</a></h5>
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="ot-heading mb-0">
                            <span class="text-primary-light">// latest case studies</span>
                            <h2 class="text-white main-heading">Introduce Our Projects</h2>
                        </div>
                    </div>
                    <div class="col-lg-5 align-self-end">
                        <p class="text-primary-light mb-0">We’ve exceled our experience in a wide range of industries to
                            bring valuable insights and provide our customers.</p>
                    </div>
                            ...
                            <div class="projects-box">
                                ...
                                <div class="portfolio-info ">
                                    <div class="portfolio-info-inner">
                                        <a class="btn-link" href="htportfolio-details-1.html"><i
        ...
        <section class="technology-v1">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                        <a class="tech-box text-center" href="/it-services">
                    ...
                    <div class="row justify-content-center">
                                ...
                                <div class="post-inner">
                                    ...
                                    <div class="inner-post">
                                        <div class="entry-header">
                                            ...
                                            <h3 class="entry-title"><a href="post.html">Plan Your Project with Your
                                                    Software</a></h3>
                                        </div><!-- .entry-header -->
                                ...
                                <div class="post-inner">
                                    ...
                                    <div class="inner-post">
                                        <div class="entry-header">
                                            ...
                                            <h3 class="entry-title"><a href="post.html">You have a Great Business
                                                    Idea?</a></h3>
                                        </div><!-- .entry-header -->
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <article class="post-box blog-item">
                                <div class="post-inner">
                                    <div class="entry-media">
                                        <div class="post-cat"><span class="posted-in"><a href="#"
                                                    rel="category tag">Development</a></span></div>
                                        <a href="post.html">
                                    ...
                                    <div class="inner-post">
                                        <div class="entry-header">
                                            ...
                                            <h3 class="entry-title"><a href="post.html">Building Data Analytics
                                                    Software</a></h3>
                                        </div><!-- .entry-header -->
