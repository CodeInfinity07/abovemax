            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 text-center text-lg-left mb-4 mb-lg-0">
                        <img src="images/big-logo-home2.png" alt="">
                    </div>
                    <div class="col-lg-6 align-self-center">
                        <div class="home2-top-right">
                            <p class="small-text">// Functional, Usability & Performance</p>
                            <h2>SOFTWARE DEVELOPMENT</h2>
                            <p class="sub-text">We transform businesses of most major sectors with powerful and adaptable
                                digital solutions that satisfy the needs of today.</p>
                            <div class="video-popup style-2">
                                <div class="btn-inner">
                                    <a class="btn-play" href="https://vimeo.com/94686522"><i class="flaticon-play"></i>
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="ot-heading mb-0">
                            ...
                            <h2 class="main-heading">For Over 15 Years. <br>For Millions of Users</h2>
                        </div>
                    </div>
                    <div class="col-lg-7 align-self-end">
                        <p class="mb-0">The development of reliable and scalable software solutions for any OS, browser
                            and device. We bring together deep industry expertise and the latest IT advancements to deliver
                            custom solutions and products that perfectly fit the needs and behavior of their users.</p>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="support-box">
                            <div class="inner-box">
                                <div class="overlay flex-middle">
                                    ...
                                    <div class="inner">
                                        <p>Entrust full-cycle implementation of your software product to our experienced
                                            BAs, UI/UX designers, developers.</p>
                                        <a href="/it-services" class="btn-details"><i
                                                class="flaticon-right-arrow-1"></i> LEARN MORE</a>
                                    </div>
                                </div>
                                <div class="content-box">
                                    <span class="number-box">01</span>
                                    <h3>Outsoursing</h3>
                                    <img src="images/flipbox1.jpg" alt="Outsoursing">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="inner-box">
                                <div class="overlay flex-middle">
                                    ...
                                    <div class="inner">
                                        <p>Entrust full-cycle implementation of your software product to our experienced
                                            BAs, UI/UX designers, developers.</p>
                                        <a href="/web-development" class="btn-details"><i
                                                class="flaticon-right-arrow-1"></i> LEARN MORE</a>
                                    </div>
                                </div>
                                <div class="content-box">
                                    ...
                                    <img src="images/flipbox2.jpg" alt="Custom Software">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="inner-box">
                                <div class="overlay flex-middle">
                                    ...
                                    <div class="inner">
                                        <p>Entrust full-cycle implementation of your software product to our experienced
                                            BAs, UI/UX designers, developers.</p>
                                        <a href="/mobile-development" class="btn-details"><i
                                                class="flaticon-right-arrow-1"></i> LEARN MORE</a>
                                    </div>
                                </div>
                                <div class="content-box">
                                    ...
                                    <img src="images/flipbox3.jpg" alt="Product Design">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="section-inner-about">
                    <div class="row">
                        <div class="col-xl-6 col-lg-12 col-md-12">
                            <div class="left-img">
                                <img src="images/image1-home2.png" alt="">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-12 col-md-12">
                            <div class="right-content">
                                ...
                                <p>AboveMax is the partner of choice for many of the world’s leading enterprises, SMEs and
                                ...
                                <p><em class="text-dark"><strong>We can help to maintain and modernize your IT
                ...
                <div class="row">
                    <div class="col-lg-6 mb-4 mb-lg-0">
                        <div class="technology-left">
                            <div class="ot-heading">
                                <span class="text-primary-light">// technology index</span>
                            ...
                            <ul class="style-none text-white">
                                <li><i class="fas fa-check"></i> Application Development</li>
                                <li><i class="fas fa-check"></i> BI Consulting and Implementation</li>
                                <li><i class="fas fa-check"></i> Machine and Deep Learning</li>
                                <li><i class="fas fa-check"></i> Data Quality Management</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <a class="tech-box text-center" href="/web-development" target="_blank">
                                    <div class="icon-main"><span class="flaticon-code-1"></span></div>
                                    <h5>WEB</h5>
                                </a>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <a class="tech-box text-center" href="/mobile-development">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <a class="tech-box text-center mb-0" href="/it-services">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <a class="tech-box text-center mb-0" href="/mobile-development">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 align-self-end">
                        <p class="mb-0">We’ve exceled our experience in a wide range of industries to bring valuable
                            insights and provide our customers.</p>
                    </div>
                    <div class="col-lg-2 align-self-end">
                        <div class="ot-button">
                            <a href="portfolio-grid.html" class="btn-details"><i class="flaticon-right-arrow-1"></i>VIEW
                                ALL PROJECTS</a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="projects-grid projects-style-1 projects-col3 projects-no-gaps">
                                ...
                                <div class="project-item development">
                                    <div class="projects-box">
                                        ...
                                        <div class="portfolio-info ">
                                            <a class="overlay" href="portfolio-details-2.html"></a>
                                            <div class="portfolio-info-inner">
                                ...
                                <div class="project-item ideas technology">
                                    <div class="projects-box">
                                        ...
                                        <div class="portfolio-info">
                                            <a class="overlay" href="portfolio-details-3.html"></a>
                                            <div class="portfolio-info-inner">
                        ...
                        <div class="indus-item">
                            <div class="item-inner">
                                ...
                                <div class="iinfo">
                                    ...
                                    <div class="itext">
                                        The global economy is moving towards a new identity. In order to remain competitive
                                        and profitable, the banking and finance.
                                    </div>
                                </div>
                            </div>
                        </div>
